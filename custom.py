...
#
#     tfidf = TFIDF(stop_words=nltk_stop_words, aggregation_F='mean')
#     tfidf.fit(texts=texts, topics=topics_unique)
#     tfidf.build_similarity_matrix()
#
#     save_obj(obj=tfidf.rel_mat,
#              name=f'input_data/relevance_matrices/TFIDF/rel_mat_TFIDF_{"keywords_" if keywords else ""}\
# {shortcut[PAPERS_TYPE]}_{shortcut[TAXONOMY_TYPE]}.pkl')
#
#     save_obj(obj=tfidf.sim_mat,
#              name=f'input_data/similarity_matrices/TFIDF/sim_mat_TFIDF_{"keywords_" if keywords else ""}\
# {shortcut[PAPERS_TYPE]}_{shortcut[TAXONOMY_TYPE]}.pkl')
